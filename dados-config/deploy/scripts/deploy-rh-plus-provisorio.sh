...
# 🚀 DEPLOY AUTOMATICO RH+ - DOMÍNIO PROVISÓRIO
# Uso: ./deploy-rh-plus-provisorio.sh
# Data: 28/04/2026
...
# Configurações - DOMÍNIO PROVISÓRIO
...
# Verificar root
if [[ $EUID -ne 0 ]]; then
   error "Execute como root: sudo ./deploy-rh-plus-provisorio.sh"
fi

log "🚀 Iniciando deploy RH+ v2.0.0 para DOMÍNIO PROVISÓRIO..."
...
log "ETAPA 4: Configurando ambiente para DOMÍNIO PROVISÓRIO..."
...
# URL Pública - DOMÍNIO PROVISÓRIO
...
# ETAPA 7: Configurar Nginx - DOMÍNIO PROVISÓRIO
log "ETAPA 7: Configurando Nginx para $DOMAIN..."
...
# ETAPA 10: Instalar SSL - DOMÍNIO PROVISÓRIO
log "ETAPA 10: Configurando SSL para $DOMAIN..."
...
if certbot --nginx -d $DOMAIN --non-interactive --agree-tos --email nit@nordesteloc.com.br; then
    ...
    warning "⚠️ SSL não instalado. Execute manualmente:"
...
echo ""
echo "================================================"
log "🚀 DEPLOY RH+ CONCLUÍDO! (DOMÍNIO PROVISÓRIO)"
echo ""
echo "📊 RESUMO:"
...
echo ""
echo "📋 VERIFICAÇÃO:"
echo "□ DNS já configurado: $DOMAIN → $(curl -s ifconfig.me)"
echo "□ SSL instalado"
echo "□ Aplicação acessível"
echo "□ Backup funcionando"
echo ""
echo "🔄 MIGRAÇÃO FUTURA:"
echo "- Quando quiser migrar para .com.br, use o script migrar-dominios.sh"
echo "================================================"
