...
function renderSidebar(user) {
    ...
    const items = [
        ...
        { id: 'overtime', label: 'Hora Extra', icon: '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', url: '/analise-hora-extra.html' },
