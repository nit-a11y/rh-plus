...
// Operações de transferência (já existentes no sistema)
const transferencias = [
    { 
        nome: 'VANESSA DOS SANTOS XAVIER', 
        cpf: '605.584.543-13', // CPF formatado como está no sistema
    ...
    { 
        ...
        cpf: '078.097.553-74', // CPF formatado como está no sistema
        de: { empresa: 'a92a33c7', unidade: 'u4' },
        para: { empresa: 'a92a33c7', unidade: 'edcfae9a' },
        data: '08/02/2025',
...
// Readmissões (já existentes no sistema)
const readmissoes = [
    { 
        nome: 'MIKAEL PRUDÊNCIO FERNANDES', 
        cpf: '067.170.173-84', // CPF formatado como está no sistema
        ciclos: [
            { 
...
// Novos colaboradores (não existentes no sistema)
