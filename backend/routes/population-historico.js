/**
 * ROTAS: HISTÓRICO TEMPORAL DE POPULAÇÃO
 * Módulo independente para gestão de histórico populacional por unidade
 * Fonte de dados: employees + companies (mesma estrutura do population)
 * Endpoints: /api/population-historico/*
 */
